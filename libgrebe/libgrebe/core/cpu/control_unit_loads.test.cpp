...
TEST_F(OpcodesLoadsTest, Test0x06)
{
	...
	state.mmu.write(state.registers.getPC() + 1, 0x69);
	// testing the opcode
	testOpcode(0x06);
	// expected change in registers and memory
	expectedState.clockCycles += 8;
	expectedState.registers.setPC(expectedState.registers.getPC() + 2);
	expectedState.registers.setB(0x69);
	// comparing expected change to real change
	EXPECT_TRUE(compareState(expectedState, state));
}
...
TEST_F(OpcodesLoadsTest, Test0x0A)
{
	...
	state.mmu.write(state.registers.getBC(), 0x69);
	// testing the opcode
	testOpcode(0x0A);
	// expected change in registers and memory
	expectedState.clockCycles += 8;
	expectedState.registers.incPC();
	expectedState.registers.setA(0x69);
	// comparing expected change to real change
	EXPECT_TRUE(compareState(expectedState, state));
}
...
TEST_F(OpcodesLoadsTest, Test0x0E)
{
	...
	expectedState.clockCycles += 8;
	expectedState.registers.setPC(expectedState.registers.getPC() + 2);
	expectedState.registers.setC(0x69);
	// comparing expected change to real change
	EXPECT_TRUE(compareState(expectedState, state));
}
...
TEST_F(OpcodesLoadsTest, Test0x12)
{
	// 0x12 LD (DE), A
	// preparing cpu and memory state before executing the opcode
	state.registers.setDE(0xbeef);
	state.registers.setA(0x69);
	state.mmu.write(state.registers.getDE(), 0);
	// testing the opcode
	testOpcode(0x12);
	// expected change in registers and memory
	expectedState.clockCycles += 8;
	expectedState.registers.incPC();
	expectedState.mmu.write(state.registers.getDE(), 0x69);
	// comparing expected change to real change
	EXPECT_TRUE(compareState(expectedState, state));
}
...
TEST_F(OpcodesLoadsTest, Test0x16)
{
	...
	expectedState.clockCycles += 8;
	expectedState.registers.setPC(expectedState.registers.getPC() + 2);
	expectedState.registers.setD(0x69);
	// comparing expected change to real change
	EXPECT_TRUE(compareState(expectedState, state));
}
...
TEST_F(OpcodesLoadsTest, Test0x1A)
{
	...
	state.registers.setDE(0xbeef);
	state.registers.setA(0);
	state.mmu.write(state.registers.getDE(), 0x69);
	// testing the opcode
	testOpcode(0x1A);
	// expected change in registers and memory
	expectedState.clockCycles += 8;
...
TEST_F(OpcodesLoadsTest, Test0x1E)
{
	...
	expectedState.clockCycles += 8;
	expectedState.registers.setPC(expectedState.registers.getPC() + 2);
	expectedState.registers.setE(0x69);
	// comparing expected change to real change
	EXPECT_TRUE(compareState(expectedState, state));
}
...
TEST_F(OpcodesLoadsTest, Test0x22)
{
	...
	state.mmu.write(state.registers.getHL(), 0);
	// testing the opcode
	testOpcode(0x22);
	// expected change in registers and memory
	expectedState.clockCycles += 8;
	expectedState.registers.incPC();
	expectedState.registers.setHL(0xdead + 1);
...
TEST_F(OpcodesLoadsTest, Test0x26)
{
	...
	expectedState.clockCycles += 8;
	expectedState.registers.setPC(expectedState.registers.getPC() + 2);
	expectedState.registers.setH(0x69);
	// comparing expected change to real change
	EXPECT_TRUE(compareState(expectedState, state));
}
...
TEST_F(OpcodesLoadsTest, Test0x2A)
{
	// 0x2A LD A, (HL+)
	// preparing cpu and memory state before executing the opcode
	state.registers.setA(0x0);
	state.registers.setHL(0xdead);
	state.mmu.write(state.registers.getHL(), 0x69);
	// testing the opcode
	testOpcode(0x2A);
	// expected change in registers and memory
	expectedState.clockCycles += 8;
...
TEST_F(OpcodesLoadsTest, Test0x2E)
{
	...
	expectedState.clockCycles += 8;
	expectedState.registers.setPC(expectedState.registers.getPC() + 2);
	expectedState.registers.setL(0x69);
	// comparing expected change to real change
	EXPECT_TRUE(compareState(expectedState, state));
}
...
TEST_F(OpcodesLoadsTest, Test0xE0)
{
	...
	// preparing cpu and memory state before executing the opcode
	state.registers.setA(0x69);
	state.mmu.write(state.registers.getPC() + 1, 0x42);
...
TEST_F(OpcodesLoadsTest, Test0xEA)
{
	...
	// preparing cpu and memory state before executing the opcode
	state.registers.setA(0x69);
	state.mmu.write(state.registers.getPC() + 1, 0xef);
	state.mmu.write(state.registers.getPC() + 2, 0xbe);
...
TEST_F(OpcodesLoadsTest, Test0x01)
{
	...
	writeWord(state, state.registers.getPC() + 1, 0xbeef);
	// testing the opcode
	testOpcode(0x01);
	// expected change in registers and memory
	expectedState.clockCycles += 12;
	expectedState.registers.setPC(expectedState.registers.getPC() + 3);
	expectedState.registers.setBC(0xbeef);
	// comparing expected change to real change
	EXPECT_TRUE(compareState(expectedState, state));
}
...
TEST_F(OpcodesLoadsTest, Test0x11)
{
	...
	expectedState.clockCycles += 12;
	expectedState.registers.setPC(expectedState.registers.getPC() + 3);
	expectedState.registers.setDE(0xbeef);
	// comparing expected change to real change
	EXPECT_TRUE(compareState(expectedState, state));
}
...
TEST_F(OpcodesLoadsTest, Test0x21)
{
	...
	expectedState.clockCycles += 12;
	expectedState.registers.setPC(expectedState.registers.getPC() + 3);
	expectedState.registers.setHL(0xbeef);
	// comparing expected change to real change
	EXPECT_TRUE(compareState(expectedState, state));
}
...
TEST_F(OpcodesLoadsTest, Test0x31)
{
	...
	expectedState.clockCycles += 12;
	expectedState.registers.setPC(expectedState.registers.getPC() + 3);
	expectedState.registers.setSP(0xbeef);
	// comparing expected change to real change
	EXPECT_TRUE(compareState(expectedState, state));
}
...
TEST_F(OpcodesLoadsTest, Test0xC1)
{
	...
	// preparing cpu and memory state before executing the opcode
	state.registers.setBC(0);
	state.registers.setSP(0xbeef);
	writeWord(state, state.registers.getSP(), 0xdead);
	// testing the opcode
	testOpcode(0xC1);
	// expected change in registers and memory
	expectedState.clockCycles += 12;
	expectedState.registers.incPC();
	expectedState.registers.setSP(expectedState.registers.getSP() + 2);
	expectedState.registers.setBC(0xdead);
	// comparing expected change to real change
	EXPECT_TRUE(compareState(expectedState, state));
}
...
TEST_F(OpcodesLoadsTest, Test0xD1)
{
	...
	expectedState.registers.incPC();
	expectedState.registers.setSP(expectedState.registers.getSP() + 2);
	expectedState.registers.setDE(0xdead);
	// comparing expected change to real change
	EXPECT_TRUE(compareState(expectedState, state));
}
...
TEST_F(OpcodesLoadsTest, Test0xE1)
{
	...
	expectedState.registers.incPC();
	expectedState.registers.setSP(expectedState.registers.getSP() + 2);
	expectedState.registers.setHL(0xdead);
	// comparing expected change to real change
	EXPECT_TRUE(compareState(expectedState, state));
}
...
TEST_F(OpcodesLoadsTest, Test0xF1)
{
	...
	expectedState.registers.incPC();
	expectedState.registers.setSP(expectedState.registers.getSP() + 2);
	expectedState.registers.setAF(0xdead);
	// comparing expected change to real change
	EXPECT_TRUE(compareState(expectedState, state));
}
...
TEST_F(OpcodesLoadsTest, Test0xC5)
{
	// 0xC5 PUSH BC
	// preparing cpu and memory state before executing the opcode
	state.registers.setBC(0xdead);
	state.registers.setSP(0xbeef);
	writeWord(state, state.registers.getSP(), 0x0000);
	// testing the opcode
	testOpcode(0xC5);
	// expected change in registers and memory
	expectedState.clockCycles += 16;
...
TEST_F(OpcodesLoadsTest, Test0xF8)
{
	...
	// preparing cpu and memory state before executing the opcode
	state.registers.setHL(0);
	state.registers.setSP(0xdead);
	state.mmu.write(state.registers.getPC() + 1, 1);
	// testing the opcode
	testOpcode(0xF8);
	// expected change in registers and memory
	expectedState.clockCycles += 12;
	...
	state.mmu.write(state.registers.getPC() + 1, 2);
	// testing the opcode
	testOpcode(0xF8);
	// expected change in registers and memory
	expectedState.clockCycles += 12;
	...
	expectedState.clockCycles += 12;
	expectedState.registers.setPC(expectedState.registers.getPC() + 2);
	expectedState.registers.setHL(0x0010);
	expectedState.registers.clearFlags();
	...
	expectedState.clockCycles += 12;
	expectedState.registers.setPC(expectedState.registers.getPC() + 2);
	expectedState.registers.setHL(0x00ef);
	expectedState.registers.clearFlags();
	expectedState.registers.setHalfCarryFlag();
	// comparing expected change to real change
	EXPECT_TRUE(compareState(expectedState, state));
...
TEST_F(OpcodesLoadsTest, Test0xF9)
{
	...
	expectedState.clockCycles += 8;
	expectedState.registers.incPC();
	expectedState.registers.setSP(0xdead);
	// comparing expected change to real change
	EXPECT_TRUE(compareState(expectedState, state));
}
